...
public class ExcursionFragment extends Fragment implements OnClickListener {
    private Button submit_exc;
    ...
    public void onClick(View v) {
        ...
        if (id== R.id.submit_exc){
            ...
            if(cursor !=null && cursor.getCount()>0) {
                ...
                insertValues.put("amID", "A21");
                DBOperator.getInstance().insert(insertValues,"OrderAmn");

                Toast.makeText(getActivity(), "Excursion booked", Toast.LENGTH_SHORT).show();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.excursion_page, container, false);
        submit_exc=(Button)rootView.findViewById(R.id.submit_exc);
        submit_exc.setOnClickListener(this);
